...
URL de Organización de GITHUB del equipo Co-Designers:
https://github.com/Co-Designers
URL de Repositorio del Project Report:
https://github.com/Co-Designers/PetCare
...
| -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
|  | | <img src="Resources/Profiles/" alt="Imagen de"/> |
|  ||<img src="Resources/Profiles/" alt="Imagen de"/> |
|  | | <img src="Resources/Profiles/" alt="Imagen de"/> |
| ||<img src="Resources/Profiles/" alt="Imagen de"/> |
|  | | <img src="Resources/Profiles/" alt="Imagen de"/> |
...
need to learn first?  </b> </div><br> <br>
        </td>
        <td valign="top">
            <div align="center">  <br><b>What's the least amount of work we need to do to learn the next most important thing?</b> </div><br> <br>
        </td>
    </tr>
</table>
